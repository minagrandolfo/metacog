const I18N = {
  fr: {
    ...
    auroc2: 'AUROC type-2 :',
    auroc2Explain: 'Probabilité que ta confiance soit plus haute sur un essai correct que sur un essai incorrect. <b>0.5 = aucune metacog</b>, <b>1.0 = metacog parfaite</b>. Moins dépendant de ta performance brute que le Brier (mais pas totalement indépendant — une dépendance résiduelle au d\' subsiste, ce qui motive le m-ratio).',
    brier: 'Brier score :',
  ...
  en: {
    ...
    auroc2: 'AUROC type-2:',
    auroc2Explain: 'Probability your confidence is higher on a correct trial than on an incorrect trial. <b>0.5 = no metacog</b>, <b>1.0 = perfect metacog</b>. Less dependent on raw performance than Brier (but not fully independent — a residual dependence on d\' remains, which is why m-ratio was developed).',
    brier: 'Brier score:',
  ...
  it: {
    ...
    auroc2: 'AUROC tipo-2 :',
    auroc2Explain: 'Probabilità che la tua fiducia sia più alta in una prova corretta che in una sbagliata. <b>0.5 = nessuna metacog</b>, <b>1.0 = metacog perfetta</b>. Meno dipendente dalla prestazione grezza rispetto al Brier (ma non totalmente indipendente — resta una dipendenza residua dal d\', motivo per cui è stato sviluppato il m-ratio).',
