const I18N = {
  fr: {
    ...
    auroc2: 'AUROC type-2 :',
    auroc2Explain: 'Ton score de <b>métacognition (sensibilité)</b>, indépendant de ta performance brute. <b>0.5 = aucune metacog</b> (ta confiance ne distingue pas tes bonnes de tes mauvaises réponses), <b>1.0 = metacog parfaite</b>. Calculé par bootstrap (intervalle de confiance à 95%).',
    brier: 'Brier score :',
  ...
  en: {
    ...
    auroc2: 'AUROC type-2:',
    auroc2Explain: 'Your <b>metacognitive sensitivity</b> score, independent of raw performance. <b>0.5 = no metacog</b> (confidence does not distinguish your correct from incorrect answers), <b>1.0 = perfect metacog</b>. Computed by bootstrap (95% confidence interval).',
    brier: 'Brier score:',
