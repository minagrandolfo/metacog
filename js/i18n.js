const I18N = {
  fr: {
    ...
    privacyNote: 'Aucune donnée n\'est envoyée. Tout reste dans ton navigateur (localStorage), uniquement pour te permettre de comparer tes sessions.',
  ...
  en: {
    ...
    privacyNote: 'No data is sent anywhere. Everything stays in your browser (localStorage), only so you can compare your own sessions.',
    btnStartReady: 'Start',
